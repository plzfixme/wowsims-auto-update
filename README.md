This repository contains a Windows batch script that automatically checks and updates the [WoWSims Mop simulator](https://github.com/wowsims/mop) to the latest release from GitHub.
